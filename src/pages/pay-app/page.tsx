...
import useNiubizPayApp from 'hooks/useNiubizPayApp';
...
const PayAppPage = () => {
    ...
    const { FormComponent, triggerOpenForm, triggerSendForm, formResponse, triggerResetForm } = useNiubizPayApp(
        "userniubiz@mail.com",
        "0",
        "44554444",
